...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <div class="min-h-screen flex flex-col items-center justify-center">
    ...
    <button type="button"  id="crear_muestra" class="px-4 py-2 bg-blue-600 text-white rounded-md shadow hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
        Crear muestra
    </button>
</div>
