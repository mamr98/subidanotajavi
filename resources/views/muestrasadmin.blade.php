...
<div class="container">
    <div class="row justify-content-center">
        <div class="row justify-content-between align-items-center mb-4 mt-4 g-3">
            <!-- Título (Izquierda) -->
            ...
            <div class="col-6 col-md-3 order-2 order-md-3 text-end">
                <button 
                    style="padding: 10px 20px; background-color: black; color: white; border: none; border-radius: 5px; cursor: pointer;" 
                    id="crear_muestra"
                >
                    Crear muestra
                </button>
